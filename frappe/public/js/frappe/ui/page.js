...
frappe.ui.Page = class Page {
	...
	add_main_section() {
		...
		if (this.single_column) {
			...
			if (!this.wrapper[0].label.includes("Workspaces")) {
				this.add_view(
					"main",
					`
					<div class="row layout-main">
						<div class="col-layout-menus" style="min-width: 16.66%; overflow-wrap: break-word; padding: 10px">
							<div class="col-layout-subs" style="font-size: initial; font-weight: 800; text-align: center; margin-bottom: 30px;">
								Available Access
								<div class="col-leftnav-access"></div>
							</div>
						</div>
						<div class="col layout-main-section-wrapper" style="min-height: calc(100vh - 282px);">
							<div class="layout-main-section" style="max-height: calc(100vh - 282px);"></div>
							<div class="layout-footer hide"></div>
						</div>
						<div class="col-lg-2 layout-side-section" style="max-height: calc(100vh - 250px); overflow: auto; background-color: white; border: none; border-radius: 6px; box-shadow: var(--btn-shadow);"></div>
					</div>
					`
				);
			} else {
