...
frappe.views.Container = class Container {
	...
	add_page(label) {
		var page = $('<div class="content page-container"></div>')
			...
			.get(0);
		$("#footer_div").remove();
		var footerdiv = $('<div id="footer_div" style="background-color: #2490EF; text-align: center; padding: 10px; margin-top: 17px; color: white;">© copyright www.hephzibahtech.com</div>').appendTo(this.container)
		page.label = label;
