...
frappe.views.Workspace = class Workspace {
	...
	prepare_container() {
		let list_sidebar = $(`
			...
			<div class="list-menu-sidebar overlay-menu-sidebar hidden-xs hidden-sm">
				Available Access <div class="desk-menu-sidebar list-unstyled sidebar-access-menu"></div>
                        </div>
