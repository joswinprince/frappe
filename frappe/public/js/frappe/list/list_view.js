...
frappe.views.ListView = class ListView extends frappe.views.BaseList {
	...
	render() {
		...
		if (this.meta.module !== "Event Streaming" && this.meta.module !== "Automation" && this.meta.module !== "Social" && this.meta.module !== "Contacts" && this.meta.module !== "Printing" && this.meta.module !== "Integrations" && this.meta.module !== "Desk" && this.meta.module !== "Geo" && this.meta.module !== "Custom" && this.meta.module !== "Email" && this.meta.module !== "Workflow" && this.meta.module !== "Website" && this.meta.module !== "Core") {
                frappe.call('frappe.core.page.permission_manager.permission_manager.get_permissions', {
                    role: 'LIMS CRS Read Write'
                }).then(r => {
                        let response = r.message;
                        if (response.length > 0) {
		                //document.getElementsByClassName("col-layout-menus")[0].innerHTML = "";
				let tempInnerHTML = ""
                                for (let step = 0; step < response.length; step++) {
                                        if (this.doctype === response[step].parent || response[step].parent === "File" || response[step].parent === "User") {
                                        } else {
                                                tempInnerHTML += "<div style='margin-top: 10px; background-color: antiquewhite; padding: 10px; border-radius: 6px; font-weight: 600px; text-align: initial;'><a href='"+ window.location.origin +"/app/"+ response[step].parent.replaceAll(" ", "-").toLowerCase() +"/view/list' >"+ response[step].parent+ "</a></div>";
                                        }
                                }
				console.log(tempInnerHTML);
				document.getElementsByClassName("col-leftnav-access")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].innerHTML = tempInnerHTML;
                        }
                });
		} else {
			if (this.page_name === "List/User/List" ) {
				if ($(".list-sidebar").length > 0 && $(".list-sidebar").find(".desk-sidebar").length > 0 && !document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].innerHTML.includes("desk-sidebar")) {
					//console.log(document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)]);
					let tempInnerHTML =  document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].innerHTML;

					document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].innerHTML = $(".list-sidebar").find(".desk-sidebar")[0].innerHTML + tempInnerHTML;
					

					for (var i = 1; i < document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes.length; i++) {
						//console.log(document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].childNodes[1].childNodes[3].innerHTML);
						var tempElement = document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i];
						console.log(tempElement);
						console.log(tempElement.classList);
						tempElement.classList.add("btn-xs");
						tempElement.classList.add("btn-secondary");
						tempElement.classList.add("setting-btn");
						tempElement.classList.add("dropdown-btn");

						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.cursor = "pointer";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.fontSize = "14px";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.marginBottom = "6px";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.textDecorationStyle = "solid";
						if (document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].innerText !== " Users") {
							document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.backgroundColor = "var(--sidebar-select-color)";
							document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.backgroundColor = "transparent";
						}
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].style.backgroundColor = "white";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].style.border = "none";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].style.borderRadius = "6px";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].style.boxShadow = "var(--btn-shadow)";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.color = "rgb(51, 60, 68)";
						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].style.padding = "8px 0px 8px 15px";

						document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].childNodes[1].childNodes[i].childNodes[1].childNodes[3].innerHTML = "";
					}


				}
			} else {
				document.getElementsByClassName("col-layout-menus")[eval(document.getElementsByClassName("col-layout-menus").length - 1)].style.display = "None";
			}
		}
	}
	...
	render_list() {
		...
		if (this.data.length > 0) {
			// append rows
			this.$result.append("<div></div><div style='max-height: calc(100vh - 380px); overflow: auto;'>" +
				this.data
					.map((doc, i) => {
						doc._idx = i;
